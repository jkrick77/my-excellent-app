...
![exist-db CI](https://github.com/jkrick77/tmp/workflows/exist-db%20CI/badge.svg)
...
1.  Download  the `tmp-1.0.0.xar` file from GitHub [releases](https://github.com/jkrick77/tmp/releases) page.
...
LGPL-3.0 © [jack_krick](http://beggarsopera.net)
...
[release-url]: https://github.com/jkrick77/tmp/releases/latest
